    ...
    <div>
      ...
      <div className="first">
        <div className="title">
          ...
          <p>
            Our charity organization is dedicated to making a positive impact in
            the lives of those in need. Through various initiatives, we provide
            support, hope, and opportunities to create lasting change in
      ...
      <div className="third">
        ...
        <div className="categories">
          ...
          <div className="mission-category">
            <img
              src="./hospital-chart-style-s-svgrepo-com.svg"
              alt="hospital icon"
              className="stat-icon"
            />
        ...
        <div className="project-container" ref={projectContainerRef}>
          ...
          {charity.map((project) => (
            <div className="projects" key={project.id}>
              ...
              <p className="card-current-amount">
                ₵{project.amountreceived}/{project.amountneeded}
              </p>
            </div>
          ))}
        </div>
      ...
      <div className="volunteer-section">
        <div className="title" id="volunteer-title">
          ...
          <p>
            ...
            and the driving force behind our impact. Their dedication, passion,
            and unwavering commitment are what make our programs and initiatives
            successful. These remarkable individuals selflessly contribute their
            time, skills, and energy to support our cause, making a tangible
        ...
        <div className="testimony">
          <div className="testimony-card">
            <p>
              "From the moment I joined as a volunteer, I knew I had found my
              place. The dedication of this foundation to its mission is
              unwavering, and I'm humbled to contribute my time and skills to
              such a worthy cause."
            </p>
          ...
          <div className="testimony-card">
            <p>
              "I am incredibly honored to be part of this foundation's volunteer
              team. The work we do here truly touches lives and brings hope to
              those in need. The sense of purpose I feel when I see the people's
              smiles."
            </p>
            <div className="profile">
              <img
          ...
          <div className="testimony-card">
            <p>
              "Volunteering with this foundation has been a transformative
              experience for me. I initially joined hoping to contribute to a
              good cause, but it turned out to be so much more."
            </p>
            <div className="profile">
              <img
                src="./profile3.jpg"
